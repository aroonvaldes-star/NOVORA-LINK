...
public sealed record NLServiceDeviceMetricsSnapshot(
    double CpuPercent,
    long UsedMemoryKb,
    long TotalMemoryKb,
    int BatteryPercent,
...
public sealed class NLServiceDeviceMetrics
{
    private readonly NLServiceADB _adb;

    public NLServiceDeviceMetrics(
        NLServiceADB adb)
    {
        _adb =
            adb ??
    ...
    public async Task<NLServiceDeviceMetricsSnapshot> GetAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new NLServiceDeviceMetricsSnapshot(
            cpuPercent,
            usedMemoryKb,
            totalMemoryKb,
            batteryPercent,
     ...
     * Total RAM: 11 GB
     *
     * El modelo NLServiceDeviceMetricsSnapshot permanece en KB.
     */
