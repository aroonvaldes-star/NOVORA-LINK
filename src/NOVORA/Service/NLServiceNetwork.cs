...
public sealed record NLServiceNetworkStatus(
    string IpAddress,
    string InterfaceName,
    bool InternetAvailable,
    long LatencyMs);

public sealed class NLServiceNetwork
{
    private readonly NLServiceADB _adb;

    public NLServiceNetwork(NLServiceADB adb)
    {
        _adb = adb;
    }

    public async Task<NLServiceNetworkStatus> GetAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        catch (InvalidOperationException)
        {
            ...
            return new NLServiceNetworkStatus(
