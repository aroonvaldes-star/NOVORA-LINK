 ...
 *
 * El RelayCore se diseña para un único dispositivo Android
 * activo por computadora.
 *
 * Este límite corresponde a clientes DATA del túnel.
 */
const MAX_CLIENTS_LE: usize = 1;
