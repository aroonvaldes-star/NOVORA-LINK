...
public sealed class LETransportListener : IAsyncDisposable
{
        ...
        try
        {
            if (IsListeningLE)
            {
                ...
                throw new InvalidOperationException(
                    $"LETransportListener ya escucha en {PortLE}.");
            }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        TcpListener listener =
            _listener ??
            throw new InvalidOperationException(
                "LETransportListener no está iniciado.");

        if (!IsListeningLE)
        {
            throw new InvalidOperationException(
                "LETransportListener no está escuchando.");
        }
