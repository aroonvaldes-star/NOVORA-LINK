...
public partial class NLUIWindowMain
{
    ...
    private IPAddress? ChooseAndroidLanAddress(bool createInvitation = true)
    {
        ...
        body.Children.Add(new TextBlock { Text = "Elige la red que comparte tu teléfono. La invitación autoriza el control. Si eliges Recordar esta PC en Android, podrá reconectar hasta que revoques ese teléfono.", TextWrapping = TextWrapping.Wrap });
        ...
        var dialog = new Window { Owner = this, Title = "Preparar conexión LAN", Width = 520,
