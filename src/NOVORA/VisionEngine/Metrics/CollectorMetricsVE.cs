...
public sealed class CollectorMetricsVE
{
    ...
    public SnapshotMetricsVE CaptureVE(
        StatusVideoVE video,
        StatusAudioVE audio,
        StatusControlVE control,
        StatesTransportVE transportState,
        SessionTransportVE? transportSession)
    {
        ...
        lock (_gateVE)
        {
            ...
            SnapshotMetricsVE snapshot = new(
                CapturedAtUtc: now,
                Video: new VideoMetricsVE(
