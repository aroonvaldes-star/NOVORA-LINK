...
/// </summary>
public static class ReportGamepadVE
{
    public const int ReportSizeVE = 15;

    public static byte[] BuildVE(StateGamepadVE state)
    {
    ...
    private static byte GetDPadVE(ButtonsGamepadVE buttons)
    {
        bool up = buttons.HasFlag(ButtonsGamepadVE.DPadUp);
        bool down = buttons.HasFlag(ButtonsGamepadVE.DPadDown);
        bool left = buttons.HasFlag(ButtonsGamepadVE.DPadLeft);
        bool right = buttons.HasFlag(ButtonsGamepadVE.DPadRight);
