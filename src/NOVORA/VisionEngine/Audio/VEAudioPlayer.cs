...
/// </summary>
public sealed class VEAudioPlayer : IDisposable
{
    ...
    private uint _resolvedPhysicalDeviceIdVE =
        VEAudioOutput.DefaultPlaybackDeviceIdVE;
    ...
    private struct VEAudioSdlAudioSpec
    {
        public int Format;
        public int Channels;
