...
/// </summary>
internal sealed class VEExchangeDrop : IDisposable
{
        ...
        Forms.DragEventArgs e)
    {
        try
        {
            ...
            FilesDroppedVE?.Invoke(
                this,
                new VEExchangeFilesDroppedEventArgs(
                    validPaths.ToArray()));
        }
        finally
        {
...
///
/// Debe ser public porque VERendererHost expone
/// FilesDroppedVE como evento público.
/// </summary>
public sealed class VEExchangeFilesDroppedEventArgs : EventArgs
{
    private readonly string[] _pathsVE;
    private readonly string[] _filesVE;
    private readonly string[] _directoriesVE;

    public VEExchangeFilesDroppedEventArgs(
