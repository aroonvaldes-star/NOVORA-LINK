...
///     /sdcard/NOVORA
/// </summary>
internal static class PathExchangeVE
{
        ...
        string localPath)
    {
        ...
        return
            $"{RootAndroidVE}/{safeName}";
    }

    /// <summary>
    /// Compatibilidad con FileExchangeVE existente.
    ///
        ...
        string name)
    {
        ...
        if (ImageExtensionsVE.Contains(extension))
        {
            return ImagesFolderVE;
        }

        if (VideoExtensionsVE.Contains(extension))
        {
            return VideosFolderVE;
        }
        ...
        if (DocumentExtensionsVE.Contains(extension))
        {
            return DocumentsFolderVE;
        }

        return FilesFolderVE;
    }
