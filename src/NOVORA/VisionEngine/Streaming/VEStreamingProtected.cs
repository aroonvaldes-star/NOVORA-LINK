...
/// </summary>
public sealed class VEStreamingProtected
{
    private static readonly IReadOnlyDictionary<string, VEStreamingProvider>
        ProvidersVE =
            new Dictionary<string, VEStreamingProvider>(
            ...
            string? androidPackage)
    {
        ...
        ProvidersVE.TryGetValue(
            androidPackage.Trim(),
            out VEStreamingProvider? provider);

        return provider;
    }

    public VEStreamingResultProtected
        OpenProviderVE(
            string androidPackage)
    {
...
public sealed record VEStreamingProvider(
    string Name,
    string AndroidPackage,
    string WindowsUri);

public sealed record VEStreamingResultProtected(
    bool Success,
    VEStreamingProvider? Provider,
    string Message,
    Exception? Exception);