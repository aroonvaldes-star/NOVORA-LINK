...
/// </summary>
public sealed class ManagerTransportVE
{
    ...
    private StatesTransportVE _state =
        StatesTransportVE.Stopped;

    public ManagerTransportVE(AdbService adb)
    {
        _adb = adb ?? throw new ArgumentNullException(nameof(adb));
    }

    public event EventHandler<StatesTransportVE>? StateChangedVE;

    public StatesTransportVE StateVE
    {
        get
        {
            lock (_statusGate)
    ...
    public async Task<TunnelTransportVE> PrepareAsync(
        string serial,
        CancellationToken cancellationToken = default)
    {
        ...
        string socketName =
            ConstantsProtocolVE.ScrcpySocketPrefixVE +
            scid.ToString("x8");

        PublishStateVE(StatesTransportVE.Preparing);
        ...
        try
        {
            ...
            PublishStateVE(StatesTransportVE.Listening);

            return new TunnelTransportVE(
                serial: normalizedSerial,
                scid: scid,
                socketName: socketName,
                localPort: reversePort,
                mode: ModeTransportVE.Reverse,
        ...
        PublishStateVE(StatesTransportVE.Failed);
    ...
    public Task<SessionTransportVE> ConnectVideoAsync(
    ...
    public Task<SessionTransportVE> ConnectAsync(
        TunnelTransportVE tunnel,
    ...
    public async Task<SessionTransportVE> ConnectAsync(
        TunnelTransportVE tunnel,
        bool videoEnabled,
        bool audioEnabled,
        bool controlEnabled,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        PublishStateVE(StatesTransportVE.Connecting);
        ...
        try
        {
            ...
            if (tunnel.Mode == ModeTransportVE.Reverse)
            {
                try
                {
            ...
            PublishStateVE(StatesTransportVE.Connected);

            return new SessionTransportVE(
                tunnel,
                videoClient,
                audioClient,
                controlClient,
        ...
        CancellationToken cancellationToken = default)
    {
        if (tunnel is null)
        {
            PublishStateVE(StatesTransportVE.Stopped);
            return;
        }
    ...
    {
        byte[] buffer =
            new byte[ConstantsProtocolVE.DeviceNameFieldLengthVE];
    ...
    private void PublishStateVE(StatesTransportVE state)
    {
        EventHandler<StatesTransportVE>? handler;
