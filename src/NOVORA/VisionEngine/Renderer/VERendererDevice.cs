...
/// </summary>
public sealed class VERendererDevice : IDisposable
{
    ...
    public VERendererDevice(NLServiceNovoraPaths paths)
    {
    ...
    public void PresentVE(IntPtr texture, VERendererRect destination, int rotationDegrees)
    {
        EnsureOpenVE();
    ...
    private struct VERendererSdlFRect
    {
        public VERendererSdlFRect(float x, float y, float w, float h)
        {
            X = x; Y = y; W = w; H = h;
        }
        public float X;
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    private delegate bool SdlRenderTextureDelegate(IntPtr renderer, IntPtr texture, IntPtr source, ref VERendererSdlFRect destination);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    private delegate bool SdlRenderTextureRotatedDelegate(IntPtr renderer, IntPtr texture, IntPtr source, ref VERendererSdlFRect destination, double angle, IntPtr center, uint flip);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
