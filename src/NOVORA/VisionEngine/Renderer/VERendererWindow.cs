...
///
/// También propaga Drag & Drop desde VERendererHost hacia
/// NLUIWindowMain.VisionEngineVE.
///
/// Importante:
...
/// </summary>
public sealed class VERendererWindow : System.Windows.Window
{
    // ============================================================
    // WIN32 CONSTANTS
    // ============================================================
    ...
    private readonly NLModelMonitorInfo _monitorVE;
    ...
    public NLModelMonitorInfo MonitorVE =>
        _monitorVE;
    ...
    {
        /*
         * VERendererWindow sólo propaga el evento.
         *
         * Aquí NO:
         *
         * - hacemos adb push
         * - consultamos serial
         * - consultamos NLServiceDeviceIdentity
         * - iniciamos polling
         *
         * NLUIWindowMain.VisionEngineVE recibe el evento
