...
/// descargar libavutil.
/// </summary>
public sealed class FrameVideoVE : IDisposable
{
        ...
        Action<IntPtr> release)
    {
        ...
        PixelFormat = Enum.IsDefined(typeof(PixelFormatVideoVE), layout.NativePixelFormat)
            ? (PixelFormatVideoVE)layout.NativePixelFormat
            : PixelFormatVideoVE.Unknown;
    ...
    public CodecProtocolVE Codec { get; }
    ...
    public PixelFormatVideoVE PixelFormat { get; }
