...
public static class HandshakeProtocolLE
{
        ...
        CancellationToken cancellationToken = default)
    {
            ...
            length > MaxPayloadLengthLE)
        {
            throw new InvalidDataException(
                $"HandshakeProtocolLE recibió una longitud inválida: {length}.");
        }
        ...
        string payload)
    {
            ...
            payloadBytes.Length > MaxPayloadLengthLE)
        {
            throw new InvalidOperationException(
                "HandshakeProtocolLE generó un payload fuera del límite permitido.");
        }
               ...
               buffer.Length)
        {
            ...
            if (read == 0)
            {
                throw new EndOfStreamException(
                    "HandshakeProtocolLE perdió el canal antes de recibir el frame completo.");
            }
