...
public sealed class VisionEnginePrivacyV1Tests
{
    [Fact]
    public void RendererEnabled_is_not_congestion()
    {
        ...
        ManagerPerformanceVE performance =
            new();

        SnapshotPerformanceVE snapshot =
    ...
    {
        MonitorRecoveryVE monitor =
            new(
                PolicyRecoveryVE.CreateDefaultVE());
    ...
    public void SecureInput_enables_privacy_shield()
    {
        ...
        Assert.False(
            privacy.CanSendControlVE(TypeControlVE.InjectText));
    ...
    {
        var options =
            OptionsPerformanceVE.CreateVE(
                ProfilePerformanceVE.Video);

        Assert.Equal(
            CodecProtocolVE.H264,
